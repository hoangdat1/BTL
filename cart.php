    ...
    <div id="content"><!-- #content Begin -->
        <div class="container"><!-- container Begin -->
            ...
            <div id="cart" class="col-md-9"><!-- col-md-9 Begin -->
                ...
                <div class="box"><!-- box Begin -->
                    ...
                    <form action="cart.php" method="post" enctype="multipart/form-data"><!-- form Begin -->
                        ...
                        <p style="color: white" class="text-muted">Bạn có <?php echo $count; ?> sản phẩm trong giỏ</p>
                            ...
                            <table class="table"><!-- table Begin -->
                                ...
                                <tbody><!-- tbody Begin -->
                                    ...
                                    while($row_cart = mysqli_fetch_array($run_cart)){
                                        ...
                                        $pro_id = $row_cart['p_id']; //id sản phẩm 
                                        ...
                                        $get_products = "select * from products where product_id='$pro_id'"; //chạy sql để lấy ra chi tiết sản phẩm có id là...
                                    ...
                                    <tr><!-- tr Begin -->
                                        ...
                                        <td>
                                            ...
                                            <a style="color: white;" href="details.php?pro_id=<?php echo $pro_id; ?>"> <?php echo $product_title; ?> </a>
                                        ...
                                        <td>
                                            ...
                                            <input type="checkbox" name="remove[]" value="<?php echo $pro_id; ?>"> <!-- Quan trọng nhất: name="remove[]" -->
                        ...
                        <div class="box-footer"><!-- box-footer Begin -->
                            ...
                            <div class="pull-right"><!-- pull-right Begin -->
                                ...
                                <button type="submit" name="update" value="Update Cart" class="btn btn-default"><!-- btn btn-default Begin --> <!-- Chú ý:  name="update" -->
            ...
            <div class="col-md-3"><!-- col-md-3 Begin -->
                ...
                <div style="color: antiquewhite;" id="order-summary" class="box"><!-- box Begin -->
            ...
            <div id="" class="col-md-12"><!-- col-md-12 Begin -->
                ...
                <?php //lấy ra 4 sản phẩm ngẫu nhiên
