...
<nav class="navbar navbar-inverse navbar-fixed-top"><!-- navbar navbar-inverse navbar-fixed-top begin -->
    <div class="navbar-header"><!-- navbar-header begin -->
        ...
        <a href="index.php?dashboard" class="navbar-brand">Trang admin Su Store</a>
        ...
        <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav begin -->
            ...
            <li><!-- li begin -->
                ...
                <ul id="cat" class="collapse"><!-- collapse begin -->
                    ...
                    <li><!-- li begin -->
                        <a href="index.php?view_cats"> Xem tất cả loại sản phẩm </a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
            ...
            <li><!-- li begin -->
                ...
                <ul id="slides" class="collapse"><!-- collapse begin -->
                    ...
                    <li><!-- li begin -->
                        <a href="index.php?view_slides"> Xem tất cả slide </a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
            ...
            <li><!-- li begin -->
                ...
                <ul id="boxes" class="collapse"><!-- collapse begin -->
                    ...
                    <li><!-- li begin -->
                        <a href="index.php?view_boxes"> Xem tất cả box </a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
            ...
            <li><!-- li begin -->
                <a href="index.php?view_payments"><!-- a href begin -->
                    <i class="fa fa-fw fa-money"></i> Xem trạng thái thanh toán
                </a><!-- a href finish -->
            </li><!-- li finish -->
            ...
            <li><!-- li begin -->
                ...
                <ul id="users" class="collapse"><!-- collapse begin -->
                    ...
                    <li><!-- li begin -->
                        <a href="index.php?view_users"> Xem tất cả Admin </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                        <a href="index.php?user_profile=<?php echo $admin_id; ?>"> Sửa thông tin Admin </a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
