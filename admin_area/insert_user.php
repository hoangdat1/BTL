                ...
                <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                    ...
                    <div class="form-group"><!-- form-group Begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 Begin -->
                            ...
                            <input name="submit" value="Thêm Admin" type="submit" class="btn btn-primary form-control">
...
if(isset($_POST['submit'])){
    ...
    elseif((mysqli_num_rows($run_check_contact) > 0)){
        ...
        if(is_uploaded_file($_FILES['admin_image']['tmp_name'])){
            ...
            $insert_user = "insert into admins (admin_name,admin_email,admin_pass,admin_address,admin_contact,admin_job,admin_image,admin_about) values ('$user_name','$user_email','$user_pass','$user_country','$user_contact','$user_job','$user_image','$user_about')";
            ...
            $insert_user = "insert into admins (admin_name,admin_email,admin_pass,admin_address,admin_contact,admin_job,admin_image,admin_about) values ('$user_name','$user_email','$user_pass','$user_country','$user_contact','$user_job','UserAdmins.jpg','$user_about')";
